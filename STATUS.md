...
- Installed: the latest normal (non-test) x86_64 build is ad-hoc signed and verified at `/Applications/FluidVoice Intel.app`; Parakeet TDT v2 (Blazing Fast - English) remains downloaded and active. Xcode 26.3 is installed at `/Applications/Xcode-26.3.0.app` and selected as the system developer tool. The previous FluidVoice build is recoverably stored in Trash as `FluidVoice Intel-before-parity-2026-08-01.app`.
